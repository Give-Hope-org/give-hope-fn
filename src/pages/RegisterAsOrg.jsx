...
import sigUp from "../assets/signUp.png";
        ...
        <div className="register-form">
          ...
          <form>
            ...
            <div className="form-group">
              ...
              >
                Organization description with a help text that displays an example
                or just a text that explains what should be filled in.
              </textarea>
            </div>
            <div className="form-group">
