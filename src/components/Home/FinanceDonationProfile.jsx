...
import './FinanceDonationProfile.css';

function FinanceDonationProfile () {
  return (
    <div className="finance-donation p-4">
      <div className="finance-donation-header">
        <h1>Finance Assistance</h1>
        <div className="flex justify-center">
          <img src={Assistance} alt="Finance" className="max-w-[40%] max-h-[50%] rounded-[40px] border-[10px]"></img>
        </div>
        <p className="font-bold text-[30px] mt-[40px]">Description:</p>
      </div>
      <div className="finance-donation-body">
      ...
      <p className="text-[35px] font-bold text-center mt-[9rem] mb-[2rem]">Request for Financial Assistance</p>
...
export default FinanceDonationProfile;