...
function BloodRequestForm() {
  ...
  return (
    <div className="blood-request-container bg-white grid grid-cols-2 min-h-[90vh] p-[4rem] mt-[5rem]">
      <div className="avatar flex align-center">
        <img src={spreadlove} alt="Avatar Image" className="w-[100%]"/>
      </div>
      <form className="blood-request-form w-[90%] max-w-[500px] m-auto bg-white rounded-[10px]">
